...
import os
import sys
from stubgen import generate_text_stub
...
""" % {
    ...
    if Options.shallMakeModule() and Options.shallCreatePyiFile():
        ...
        contents = """\
        # This file was generated by Nuitka and generates the type stubs of the
        # created shared library.

        # it lists the imports made and can be used by the
        # tools that bundle libraries, including Nuitka itself. For instance
        # standalone mode usage of the created library will need it.

        # this also contains type information for values
        # in the module, so IDEs will use this.

        # This is not Python source even if it looks so. Make it clear for
        # now. This was decided by PEP 484 designers.
        """

        stubs = generate_text_stub(
